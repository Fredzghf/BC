...
import com.example.bc.MainActivityOld.Companion.binomialDistribution
import com.example.bc.MainActivityOld.Companion.fullPrecision
import com.example.bc.MainActivityOld.Companion.pX
import com.example.bc.MainActivityOld.Companion.pXGreater
import com.example.bc.MainActivityOld.Companion.pXGreaterOrEqual
import com.example.bc.MainActivityOld.Companion.pXLess
import com.example.bc.MainActivityOld.Companion.pXLessOrEqual
import com.example.bc.MainActivityOld.Companion.percentage
import com.example.bc.MainActivityOld.Companion.textpX
import com.example.bc.MainActivityOld.Companion.textpXGreater
import com.example.bc.MainActivityOld.Companion.textpXGreaterOrEqual
import com.example.bc.MainActivityOld.Companion.textpXLess
import com.example.bc.MainActivityOld.Companion.textpXLessOrEqual
...
class MainActivityOld : ComponentActivity() {
    ...
    companion object {
        ...
        var binomialDistribution: BinomialDistribution = BinomialDistribution(0, 0.0, 0)
    }
...
private fun displayProbabilities() {
    pX.value = toProbability(binomialDistribution.probabilityEquals)
    pXLessOrEqual.value = toProbability(binomialDistribution.probabilityLessThanOrEqual)
    pXGreaterOrEqual.value = toProbability(binomialDistribution.probabilityGreaterThanOrEqual)
    pXLess.value = toProbability(binomialDistribution.probabilityLessThan)
    pXGreater.value = toProbability(binomialDistribution.probabilityGreaterThan)
}

private fun displayPercentages() {
    pX.value = toPercentage(binomialDistribution.probabilityEquals)
    pXLessOrEqual.value = toPercentage(binomialDistribution.probabilityLessThanOrEqual)
    pXGreaterOrEqual.value = toPercentage(binomialDistribution.probabilityGreaterThanOrEqual)
    pXLess.value = toPercentage(binomialDistribution.probabilityLessThan)
    pXGreater.value = toPercentage(binomialDistribution.probabilityGreaterThan)
}
...
fun toPercentage(probability: Double): String {
    return if (fullPrecision.value)
        "%09f%%".format(locale = Locale.ENGLISH, probability * 100)
    else
        "%05.2f%%".format(locale = Locale.ENGLISH, probability * 100)
}
